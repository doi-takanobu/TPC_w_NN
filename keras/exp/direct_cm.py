...
x2 = MaxPooling2D(pool_size=(4,4))(x1_2)
...
x4 = MaxPooling2D(pool_size=(4,4))(x3_2)
x5 = Flatten()(x4)
x6 = Dense(256,activation="sigmoid")(x5)
y6 = Dense(256,activation="sigmoid")(x5)
x7 = Dropout(0.5)(x6)
y7 = Dropout(0.5)(y6)
x8 = Dense(32,activation="sigmoid")(x7)
y8 = Dense(32,activation="sigmoid")(y7)
x9 = Dropout(0.5)(x8)
y9 = Dropout(0.5)(y8)
...
csvlogger = CSVLogger("direct_exp_cm.csv")
cb = [csvlogger]
if TENSOR_BOARD==1:
...
model.save("direct_exp_cm.h5")

print("begin prediction")
start = time.time()
pred_dx,pred_thr = model.predict(cell_test)
end = time.time()
np.savetxt("direct_exp_cm.dat",np.concatenate((pred_dx,pred_thr),axis=1),header="dx theta phi")
