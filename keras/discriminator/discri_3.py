...
x = AveragePooling2D(pool_size=(2,2))(anode_input)
y = AveragePooling2D(pool_size=(2,2))(cathode_input)
...
model.compile(loss="categorical_crossentropy",
              optimizer=sgd,
              metrics=["accuracy"])
#plot_model(model,"discri_3.png")

##========== fitting ==========##
csvlogger = CSVLogger("discri_3.csv")
